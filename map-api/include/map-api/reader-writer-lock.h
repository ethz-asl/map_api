...
class ReaderWriterMutex {
 public:
  ...
  ReaderWriterMutex()
      : num_readers_(0), num_pending_writers_(0), current_writer_(false) {}
...
class ScopedReadLock {
 public:
  explicit ScopedReadLock(ReaderWriterMutex* rw_lock) : rw_lock_(rw_lock) {
...
class ScopedWriteLock {
 public:
  explicit ScopedWriteLock(ReaderWriterMutex* rw_lock) : rw_lock_(rw_lock) {
