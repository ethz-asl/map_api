...
void NetTableIndex::seekPeers(const map_api_common::Id& chunk_id,
...
void NetTableIndex::announcePosession(const map_api_common::Id& chunk_id) {
  std::string peers_string;
...
void NetTableIndex::renouncePosession(const map_api_common::Id& chunk_id) {
  std::string peers_string;
  proto::PeerList peers;
...
// REQUESTS
// ========
bool NetTableIndex::rpc(const PeerId& to, const Message& request,
                        Message* response) {
  CHECK_NOTNULL(response);
  Message to_be_sent;
  proto::RoutedChordRequest routed_request;
...
bool NetTableIndex::getClosestPrecedingFingerRpc(const PeerId& to,
                                                 const Key& key,
                                                 PeerId* result) {
...
bool NetTableIndex::replaceRpc(const PeerId& to, const PeerId& old_peer,
...
bool NetTableIndex::addDataRpc(const PeerId& to, const std::string& key,
...
bool NetTableIndex::retrieveDataRpc(const PeerId& to, const std::string& key,
                                    std::string* value) {
  CHECK_NOTNULL(value);
  Message request, response;
...
bool NetTableIndex::fetchResponsibilitiesRpc(const PeerId& to,
...
bool NetTableIndex::pushResponsibilitiesRpc(const PeerId& to,
