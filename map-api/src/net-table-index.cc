...
const char NetTableIndex::kFetchReplicationDataRequest[] =
    "fetch_chord_replication_data";
const char NetTableIndex::kFetchReplicationDataResponse[] =
...
MAP_API_PROTO_MESSAGE(NetTableIndex::kAppendReplicationDataRequest,
                      proto::FetchResponsibilitiesResponse);
MAP_API_PROTO_MESSAGE(NetTableIndex::kFetchReplicationDataRequest,
                      proto::FetchReplicationDataRequest);
MAP_API_PROTO_MESSAGE(NetTableIndex::kFetchReplicationDataResponse,
                      proto::FetchResponsibilitiesResponse);
