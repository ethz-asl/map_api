...
void SpatialIndex::announceChunk(const map_api_common::Id& chunk_id,
...
void SpatialIndex::seekChunks(const BoundingBox& bounding_box,
                              map_api_common::IdSet* chunk_ids) {
...
const char SpatialIndex::kRoutedChordRequest[] = "map_api_spatial_index_request";
...
void SpatialIndex::localUpdateCallback(const std::string& key,
  ...
  map_api_common::IdList new_chunks;
