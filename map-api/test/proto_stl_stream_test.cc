...
using ContainerType = typename stxxl::VECTOR_GENERATOR<T>::result;
...
TYPED_TEST_P(ProtoSTLStream, ReserveWorks) { this->pool_.Reserve(10); }
...
REGISTER_TYPED_TEST_CASE_P(ProtoSTLStream, ReserveWorks,
                           ...
                           BackupOverBlockBoundsWorks, RetrieveDataBlockWorks,
                           SizeWorks, IsIndexInBoundsWorks,
                           OutputStreamByteCountWorks, OutputStreamNextWorks,
                           OutputStreamBackUpWorks, InputStreamByteCountWorks,
                           InputStreamNextWorks, InputStreamBackUpWorks,
                           InputStreamSkipWorks, ProtoManualSerializationWorks,
                           ProtoAutoSerializationWorks);

typedef ::testing::Types<SizeHolder<5>, SizeHolder<10>, SizeHolder<50>,
                         SizeHolder<100>, SizeHolder<1024>, SizeHolder<2048>,
